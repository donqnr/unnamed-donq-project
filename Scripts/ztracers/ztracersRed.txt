...
// Copying this thing for a red version
// Maybe there's a better way to do this but i fail at code i guess - Donq

class _ZTracerRed : FastProjectile
{
	...
	const TRACERSTEP		= 0.0075; // float
	const TRACERFANCYSTEP	= 0.005; // float
	...
	static const color colours[] = {
		...
		"e1 66 66",
		"e6 7f 7f",
		"e6 7f 7f" /* appears twice so a segment of this color is longer
					than the others. */
		};
